cordova.define("com.phonegap.plugins.devtodev.DevToDevPlugin", function (require, exports, module) {
    (function (window) {
        ...
        devtodev.prototype.setTrackingAvailability = function (trackingAllowed, successCallback, failureCallback) {
            return cordova.exec(successCallback, failureCallback, 'DevToDevPlugin', 'setTrackingAvailability', [bool2ObjC(trackingAllowed)]);
        };
        ...
        devtodev.prototype.notificationOpenCallback = function (notification, action) {
            var pushEvent = document.createEvent('HTMLEvents');
            pushEvent.initEvent('onPushOpened', true, true, notification, action);
            document.dispatchEvent(pushEvent);
        };
